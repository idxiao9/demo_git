...
// git comands:
// git config --global user.name "someone" 首次安装git后要配置用户
...
// git init 初始化git仓库
// echo " # demo_git" >> filename 从远程仓库获取文件 这个理解是错误的
...
// 标签管理
// git tag 查看所有标签 git tag tagName 创建标签
// git tag -a tagName -m "some info" 指定提交时的信息 git tag -d tagName 删除标签
// git push origin tagName 标签发布
